...
def send_transaction(sender, ip, receiver, ip2, amount, i):
    ...
    if (response.status_code == 200):
        ...
        print(f"Transaction {i} from {sender} to {receiver} failed due to insufficient coins.")
    else:
        print(f"Transaction {i} from {sender} to {receiver} was unsuccessful :(((")
